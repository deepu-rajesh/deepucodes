                ...
                <table border="1" style="table-layout: fixed;">
                  <tr>
                    <td halign="center" style="word-wrap: break-word;" valign="top">
                      <p>
                        <a href="{RESULT_DIR}\{img_name}_mask.png">
                          <img src="{RESULT_DIR}\{img_name}_mask.png" style="width:256px">
                        </a><br>
                        <p>img_m</p>
                      </p>
                    </td>
                    <td halign="center" style="word-wrap: break-word;" valign="top">
                      <p>
                        <a href="{RESULT_DIR}\{img_name}_truth.png">
                    ...
                    <td halign="center" style="word-wrap: break-word;" valign="top">
                      <p>
                        <a href="{RESULT_DIR}\{img_name}_out.png">
