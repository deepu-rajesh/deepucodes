...
######################################################################################
# base function for net2 structure
######################################################################################


def init_weights(net, init_type='normal', gain=0.02):
    """Get different initial method for the net2 weights"""
    def init_func(m):
    ...
    print('initialize net2 with %s' % init_type)
    net.apply(init_func)
...
def get_norm_layer(norm_type='batch'):
    """Get the normalization layer for the net2s"""
    if norm_type == 'batch':
...
def get_nonlinearity_layer(activation_type='PReLU'):
    """Get the activation layer for the net2s"""
...
def init_net(net, init_type='normal', gpu_ids=[]):
    """print the net2 structure and initial the net2"""
    print_net2(net)
...
def _freeze(*args):
    """freeze the net2 for forward process"""
    for module in args:
        if module:
...
def _unfreeze(*args):
    """ unfreeze the net2 for parameter update"""
    for module in args:
        if module:
            for p in module.parameters():
